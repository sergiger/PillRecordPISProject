...
class ReminderListAdapter (
    ...
    val reminderList : Array<UnplannedMedicineReminder>
) : BaseAdapter() {
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        val doseTextView : TextView = view.findViewById(R.id.reminder_info)
        ...
        nameTextView.text = i.id
        doseTextView.text = i.dose.toString() + " " + i.doseUnit
        timeTextView.text = i.hour.toString()
